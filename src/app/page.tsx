            ...
            <div className="bg-gradient-to-r from-orange-400 to-yellow-300 p-8">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="mt-1 text-xl text-white">Ani Soundは、Web Audio APIを活用して制作された独自の音楽と、息をのむようなアニメーションが融合した新しいフォームのマルチメディアコンテンツをご提供します。</p>
                </div>
              </div>
            </div>
            <div className="p-6">
              <h3 className="text-2xl font-bold">製作理由</h3>
              <p className="mt-2 text-xl">Web Audio APIを用いたアニメーションを表現することを目標として作成した。</p>
            ...
            <div className="bg-gradient-to-r from-orange-400 to-yellow-300 p-8">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="mt-1 text-xl text-white">再生ボタンを押すと以下の様にアニメーションと音が作動します</p>
                </div>
              </div>
            </div>
            <div className="p-6">
              <Image src="/ani-sound.gif" alt="me" width="1000" height="500" />
            </div>
          </div>
        </div>
      </div>
